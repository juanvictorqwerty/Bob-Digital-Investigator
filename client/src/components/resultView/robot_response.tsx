      ...
      {collapsed ? (
        ...
        >
          ...
          <div className="flex-1 min-w-0 flex flex-wrap items-center gap-x-3 gap-y-0.5">
            ...
            {robot.short_summary && (
              <p className={`text-xs ${cfg.text} truncate max-w-[500px]`}>{robot.short_summary}</p>
            )}
          </div>
          <svg className={`w-5 h-5 shrink-0 text-gray-400 transition-transform`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="transition-all">
          ...
          <div className="flex items-center justify-between mb-3">Quand je vois Nginx moi c'est une mauvaise nouvelle
            ...
            <button
              ...
              className="w-7 h-7 flex items-center justify-center rounded-lg hover:bg-gray-200 transition-colors text-gray-500"
              title="Collapse"
            >
